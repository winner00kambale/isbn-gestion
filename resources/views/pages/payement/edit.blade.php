            ...
            <div class="col-xxl-12">
                <div class="card mb-3">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Modifier paiement</h5>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row gx-3">
                                ...
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="mb-3">
                                        <label class="form-label">Montant (chiffres)</label>
                                        <input type="number" name="montant_chiffre" step="0.01"
                                            value="{{ old('montant_chiffre', $payement->montant_chiffre) }}"
                                ...
                                <div class="col-lg-8 col-sm-6 col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="montant_lettre"
                                            value="{{ old('montant_lettre', $payement->montant_lettre) }}"
                                        ...
                                        <select name="code_type"
                                            ...
                                            @foreach ($types as $type)
                                                <option value="{{ $type->id }}"
                                                    {{ old('code_type', $payement->code_type) == $type->id ? 'selected' : '' }}>
                                                    {{ $type->designation }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select name="code_inscription"
                                            ...
                                            @foreach ($inscriptions as $inscription)
                                                <option value="{{ $inscription->id }}"
                                                    {{ old('code_inscription', $payement->code_inscription) == $inscription->id ? 'selected' : '' }}>
                                                    {{ $inscription->etudiant->nom }}
                                                    {{ $inscription->etudiant->postnom }}
                                ...
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="date_payement"
                                            value="{{ old('date_payement', \Carbon\Carbon::parse($payement->date_payement)->format('Y-m-d')) }}"
